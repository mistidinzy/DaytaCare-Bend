...
namespace DaytaCare.Migrations
{
    ...
    [Migration("20211103201312_RemovedUnecessaryNavPropFromAmenity")]
    partial class RemovedUnecessaryNavPropFromAmenity
    {
            ...
            modelBuilder.Entity("DaytaCare.Models.DaycareAmenity", b =>
                {
                    ...
                    b.HasOne("DaytaCare.Models.Daycare", "Daycare")
                        .WithOne("DaycareAmenity")
                        .HasForeignKey("DaytaCare.Models.DaycareAmenity", "DaycareId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
